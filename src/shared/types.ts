...
export enum ProspectType {
  ...
  COUNTS_LEARNING = 'COUNTS_LEARNING',
  RECOMMENDED = 'RECOMMENDED',
  TIMESPENT_LEARNING = 'TIMESPENT_LEARNING',
  TITLE_URL_LEARNING = 'TITLE_URL_LEARNING',
  DISMISSED = 'DISMISSED',
}
//TODO: filtering logic in prospect-api?
...
export const ScheduledSurfaces: ScheduledSurface[] = [
  {
    ...
    prospectTypes: [
      ...
      ProspectType.COUNTS_LEARNING,
      ProspectType.RECOMMENDED,
      ProspectType.TIMESPENT_LEARNING,
      ProspectType.TITLE_URL_LEARNING,
